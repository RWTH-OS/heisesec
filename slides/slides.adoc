...
=== Unsichere Codeabschnitte

* *unsafe* Codeabschnitte können diese Techniken aushebeln
* Um mögliche Stackangriffe zu vermeiden, werden wachsende Elemete nicht auf dem Stack gelegt

image::images/stack.png[width=500]

== Kein 'billion dollar mistake'

* Frei nach Tony Hoare (Erfinder von ALGOL)
* NULL is ein Wert, der kein Wert ist.
* Rust kennt null, aber nur für 'raw, unsafe' Pointer.

[NOTE.speaker]
--
Erfunden in ALGOL, kopiert von fast allen.
Erzählen wieso NULL schlecht ist:
* Benötigt manuellen check (den man vergisst)
--

=== Sum Types

* Auch tagged unions.
* Rust benutzt Option<T> für optionale Werte und
...
[NOTE.speaker]
--
Keine Exceptions ins Rust.
--

== Strings

* Nicht NULL terminiert, sondern Start + Länge.
* Format Strings (für zB println!) müssen Compilezeit Konstanten sein.
...
** Die Laufzeitumgebung vermeidet Pufferüberläufe
